  ...
  : <MessageBox variant='danger'>{error}</MessageBox>
      ...
      <form className='w-6/12 mx-auto rounded-lg bg-orange-400 p-8 px-8'  onSubmit={handleSubmit(insertHandler)} >
        ...
        <div className='flex flex-col text-white py-2'>
          ...
          <input
            id='type'
            className='rounded-lg bg-white mt-2 p-2 text-black focus:border-orange-400  focus:outline-none'
            type='text'
        ...
        <div className='flex flex-col text-white py-2'>
          ...
          <input
            id='Description'
            className='p-2 rounded-lg bg-white mt-2 text-black focus:border-orange-400  focus:outline-none'
            type='text'
            maxLength={255}
        ...
        <div className='flex flex-col text-white py-2'>
          <label htmlFor='solarImage'  className='font-bold text-white'>Add Image</label>
          <input
            id='solarImage'
           type="file"
            className='p-2 rounded-lg bg-white mt-2 text-black focus:border-orange-400 focus:outline-none'

...
<div className='bg-amber-100  flex flex-col justify-start w-full col-span-10 p-5'>
          ...
          {loading ? (
            ...
            <table className='shadow-2x1 font-[Poppins] border-2 border-slate-200 mt-4 w-full overflow-x-auto'>
            {/* // <table className='shadow-2x1 font-[Poppins] border-2 border-cyan-200 w-11/12 mx-auto'> */}
              <thead className='text-white'>
                <tr>
                  ...
                  <th className='py-3  bg-slate-500 font-bold text-lg text-center w-10'>Capacity</th>
              ...
              <tbody>
                {batteries.map((row, index) => (
                  <tr key={index} className='hover:bg-yellow-100 bg-orange-400 cursor-pointer duration-300'>
                    ...
                    <td className='py-3 px-6 text-center xs:py-0'><div className='flex flex-row justify-center'><img src={row.batteryImage} alt="Battery" className='md:w-40 xs:w-full' /></div> </td>

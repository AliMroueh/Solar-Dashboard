...
import { 
 ...
 export interface UserSigninState {
  ...
  export const userDetailsReducer = (state: UserRegisterState = {loading: true}, action: UserAction) => {
    switch(action.type){
...
export const userUpdateProfileReducer = (state: UserRegisterState = {}, action: UserAction) => {
    switch(action.type){
